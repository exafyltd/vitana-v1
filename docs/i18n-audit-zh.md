...
Generated: 2026-09-23T08:43:45.301Z via **gemini**
...
| screens.json | 11001 | 3 | 146 | 11150 |
...
- `business.json:business.kpi.totalEarned` — **EDIT_SUGGESTED** (0.90) — Awkward phrasing; '赚取' is a verb, making the phrase sound like 'total to earn' rather than 'total amount earned'.
  - suggested: `总收益`
- `calendar.json:calendar.bookedActivities` — **EDIT_SUGGESTED** (1.00) — brand token "VITANA" missing from target
- `calendar.json:calendar.autopilot.suggestions` — **EDIT_SUGGESTED** (0.90) — The hyphen is not idiomatic in Chinese for this phrase.
  - suggested: `自动驾驶建议`
...
- `discount.json:discount.tapToApply` — **LOW_CONFIDENCE** (0.00) — audit failed: Gemini HTTP 429: {
  "error": {
    "code": 429,
    "message": "You exceeded your current quota, please check your plan and billing details. For more information on this error, head to: https://ai.google.dev/gemini-api/docs/rate-limits. To monitor your current usage, head to: https://ai.dev/rate-limit. \n* Quota ex
- `drawerNav.json:drawerNav.connectors` — **EDIT_SUGGESTED** (0.90) — The translation '联系' (contact/connection) is too vague and does not accurately convey 'Connected Apps'. It could be misinterpreted as 'Contact Us' or 'Contacts'.
  - suggested: `已连接的应用`
...
- `onboarding.json:onboarding.joinCommunityDesc` — **LOW_CONFIDENCE** (0.00) — audit failed: Gemini HTTP 429: {
  "error": {
    "code": 429,
    "message": "You exceeded your current quota, please check your plan and billing details. For more information on this error, head to: https://ai.google.dev/gemini-api/docs/rate-limits. To monitor your current usage, head to: https://ai.dev/rate-limit. \n* Quota ex
- `payment.json:payment.requestIs` — **EDIT_SUGGESTED** (0.90) — Slightly formal and verbose for an informal app's register. '的状态为' is less direct than needed.
  - suggested: `此请求{status}。`
- `profile.json:profile.account.sections.publicProfileSubtitle` — **EDIT_SUGGESTED** (0.90) — Awkward phrasing, too literal for a UI string. '身份' is too general.
  - suggested: `在个人资料中显示`
...
- `screens.json:screens.home.vitanaIndexEyebrow` — **EDIT_SUGGESTED** (1.00) — brand token "VITANA" missing from target
- `screens.json:screens.common.briefTitleForYourIdea` — **LOW_CONFIDENCE** (0.00) — audit failed: Gemini HTTP 429: {
  "error": {
    "code": 429,
    "message": "You exceeded your current quota, please check your plan and billing details. For more information on this error, head to: https://ai.google.dev/gemini-api/docs/rate-limits. To monitor your current usage, head to: https://ai.dev/rate-limit. \n* Quota ex