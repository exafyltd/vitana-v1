...
Generated: 2026-09-16T08:43:53.690Z via **gemini**
...
| screens.json | 10896 | 3 | 144 | 11043 |
...
- `billing.json:billing.features.priorityPractitioner` — **EDIT_SUGGESTED** (0.90) — The term '访问' (access/visit) is a bit ambiguous and less idiomatic for 'access to practitioners'. '接触' (contact) or '互动' (interaction) would be clearer.
  - suggested: `优先接触从业者`
- `billing.json:paywall.match_reveals.title` — **EDIT_SUGGESTED** (0.90) — '揭示' (reveal/disclose) is slightly formal for a UI button. '查看' (view) is more common and natural for revealing a match.
  - suggested: `查看匹配`
