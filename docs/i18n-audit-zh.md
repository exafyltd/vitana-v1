...
Generated: 2026-09-13T08:26:58.778Z via **gemini**
...
- `billing.json:billing.features.priorityPractitioner` — **EDIT_SUGGESTED** (0.90) — The term '从业者' (practitioner) is a bit formal and general for a friendly wellness app. The phrasing '从业者访问' is also slightly ambiguous. '专业人士' (professional) is more common and natural in this context, and '访问专业人士' clarifies the meaning.
  - suggested: `优先访问专业人士`
- `billing.json:paywall.match_reveals.title` — **EDIT_SUGGESTED** (0.90) — '揭示' (reveal) is too formal for a button action in a friendly app. '查看' (view) is more common and natural for 'reveal match' in this context.
  - suggested: `查看匹配`
- `business.json:business.earning.readyToEarn` — **EDIT_SUGGESTED** (1.00) — brand token "VITANA" missing from target
- `business.json:business.kpi.totalEarned` — **EDIT_SUGGESTED** (0.90) — Awkward phrasing; '总赚取' is not idiomatic as a standalone noun phrase for 'Total earned'.
  - suggested: `总收益`
