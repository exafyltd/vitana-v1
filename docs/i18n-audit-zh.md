...
Generated: 2026-08-29T10:16:22.828Z via **gemini**
...
- `billing.json:billing.features.priorityPractitioner` — **EDIT_SUGGESTED** (0.90) — Ambiguous phrasing; '优先从业者访问' could mean 'access to priority practitioners' rather than 'priority access for practitioners'.
  - suggested: `从业者优先访问`
- `billing.json:paywall.match_reveals.title` — **EDIT_SUGGESTED** (0.90) — '揭示' (reveal) is a bit formal/dramatic for a UI action; '查看' (view) is more common and natural.
  - suggested: `查看匹配`
- `business.json:business.earning.readyToEarn` — **EDIT_SUGGESTED** (1.00) — brand token "VITANA" missing from target
- `business.json:business.kpi.totalEarned` — **EDIT_SUGGESTED** (0.90) — The phrase '总赚取' is grammatically awkward as a noun phrase for 'Total earned'. It sounds like 'total to earn' rather than 'total earnings' or 'total amount earned'.
  - suggested: `累计收益`
...
- `mobileNav.json:mobileNav.business` — **LOW_CONFIDENCE** (0.00) — audit failed: Gemini HTTP 429: {
  "error": {
    "code": 429,
    "message": "You exceeded your current quota, please check your plan and billing details. For more information on this error, head to: https://ai.google.dev/gemini-api/docs/rate-limits. To monitor your current usage, head to: https://ai.dev/rate-limit. \n* Quota ex
- `newsCard.json:newsCard.detail.continueReading` — **EDIT_SUGGESTED** (0.90) — Overly literal and slightly formal for 'on'; not idiomatic for a friendly app. '在以下位置' implies a list or specific formal reference, which is unlikely for a simple 'continue reading' prompt.
  - suggested: `继续阅读`
...
- `packages.json:packages.items` — **LOW_CONFIDENCE** (0.00) — audit failed: Gemini HTTP 429: {
  "error": {
    "code": 429,
    "message": "You exceeded your current quota, please check your plan and billing details. For more information on this error, head to: https://ai.google.dev/gemini-api/docs/rate-limits. To monitor your current usage, head to: https://ai.dev/rate-limit. \n* Quota ex
- `payment.json:payment.requestIs` — **LOW_CONFIDENCE** (0.00) — audit failed: Gemini HTTP 429: {
  "error": {
    "code": 429,
    "message": "You exceeded your current quota, please check your plan and billing details. For more information on this error, head to: https://ai.google.dev/gemini-api/docs/rate-limits. To monitor your current usage, head to: https://ai.dev/rate-limit. \n* Quota ex
