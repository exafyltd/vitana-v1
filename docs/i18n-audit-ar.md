...
Generated: 2026-06-23T07:02:27.216Z via **gemini**
...
| onboarding.json | 18 | 5 | 0 | 23 |
| sidebar.json | 13 | 33 | 0 | 46 |
| vitanaIndex.json | 13 | 14 | 0 | 27 |

## Sample of flagged keys

- `auth.json:auth.contactAdmin` — **EDIT_SUGGESTED** (0.90) — The term 'المدير' (al-mudeer) is masculine. 'Administrator' can be male or female. 'المسؤول' (al-mas'ool) is a more gender-neutral and commonly used term for 'administrator' or 'responsible party' in UI contexts.
