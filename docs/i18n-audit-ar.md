...
Generated: 2026-05-20T07:00:22.821Z via **gemini**
...
| sidebar.json | 10 | 34 | 0 | 44 |
| vitanaIndex.json | 13 | 8 | 0 | 21 |

## Sample of flagged keys

- `auth.json:auth.contactAdmin` — **EDIT_SUGGESTED** (0.90) — 'المدير' (the manager) is not the most precise term for 'administrator' in a technical context, and 'your' is missing. 'مسؤولك' (your administrator/responsible person) is more appropriate.
  - suggested: `يرجى الاتصال بمسؤولك للحصول على الوصول`
