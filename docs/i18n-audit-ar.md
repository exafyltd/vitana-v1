...
Generated: 2026-07-08T06:11:03.035Z via **gemini**
...
| discover.json | 9 | 65 | 0 | 74 |
| drawerNav.json | 4 | 13 | 0 | 17 |
| onboarding.json | 20 | 3 | 0 | 23 |
| sidebar.json | 12 | 34 | 0 | 46 |
| vitanaIndex.json | 14 | 13 | 0 | 27 |

## Sample of flagged keys

- `auth.json:auth.contactAdmin` — **EDIT_SUGGESTED** (1.00) — 'Administrator' is better translated as 'المسؤول' (the responsible person/administrator) rather than 'المدير' (the manager/director) in a tech context.
