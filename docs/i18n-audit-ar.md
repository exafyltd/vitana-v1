...
Generated: 2026-05-23T06:22:26.989Z via **gemini**
...
- `auth.json:auth.contactAdmin` — **EDIT_SUGGESTED** (0.90) — 'Your administrator' is translated as 'the administrator' instead of 'your administrator', which is more personal and fits the informal register.
