...
Generated: 2026-07-06T07:59:35.743Z via **gemini**
...
- `auth.json:auth.contactAdmin` — **EDIT_SUGGESTED** (0.90) — Missing 'your' for 'administrator'. 'المدير' is generic, 'مديرك' is specific.
