...
await shot('04-draft-payment-bookkeeper-lookup-refused-en', { role: 'backoffice', lang: 'en-US', path: '/backoffice/finance/payments', steps: [
  { click: '[data-testid="draft-open-payment"]', wait: 1500 }, { shot: '-1-form-customer-lookup-refused' }, { fill: 'input[name="party_id"]', value: '2a806449-489d-4a62-9598-91da50b18ff9' }, { fill: 'input[name="paid_amount"]', value: '250' }, { select: 'paid_from_account', option: '1120' }, { select: 'paid_to_account', option: '1110' }, { click: '[data-testid="draft-review"]', wait: 800 }, { shot: '-2-review-card' }] });
