...
await shot('01-accounting-journals-admin-en', { ...A, path: '/backoffice/accounting/journals', click: 'table tbody tr' });
await shot('02-accounting-chart-of-accounts-admin-en', { ...A, path: '/backoffice/accounting/chart-of-accounts', click: 'table tbody tr:nth-child(3)' });
await shot('03-accounting-periods-admin-en', { ...A, path: '/backoffice/accounting/periods' });
await shot('04-accounting-journals-admin-de', { role: 'admin', lang: 'de-DE', path: '/backoffice/accounting/journals', click: 'table tbody tr' });
await shot('05-accounting-chart-of-accounts-admin-ar-rtl', { role: 'admin', lang: 'ar-XA', path: '/backoffice/accounting/chart-of-accounts', rtl: true, click: 'table tbody tr:nth-child(3)' });
await shot('06-accounting-periods-bookkeeper-de', { role: 'backoffice', lang: 'de-DE', path: '/backoffice/accounting/periods' });
await shot('07-accounting-journals-salesperson-no-access-en', { role: 'backoffice', lang: 'en-US', path: '/backoffice/accounting/journals' });
