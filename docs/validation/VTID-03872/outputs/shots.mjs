...
const B = { role: 'backoffice', lang: 'en-US' };
await shot('01-draft-journal-bookkeeper-en', { ...B, path: '/backoffice/accounting/journals', steps: [
  { click: '[data-testid="draft-open-journal"]', wait: 1500 }, { shot: '-1-form-empty' },
  { click: '[data-testid="draft-review"]', wait: 400 }, { shot: '-2-validation-no-lines' },
  { select: 'lines.0.account_id', option: '5300' }, { fill: 'input[name="lines.0.debit"]', value: '120' }, { select: 'lines.1.account_id', option: '1110' }, { fill: 'input[name="lines.1.credit"]', value: '100' }, { shot: '-3-unbalanced-live' },
  { click: '[data-testid="draft-review"]', wait: 400 }, { shot: '-4-validation-unbalanced' },
  { fill: 'input[name="lines.1.credit"]', value: '120' }, { fill: 'input[name="remark"]', value: 'Office supplies paid from bank' }, { click: '[data-testid="draft-add-line-lines"]', wait: 300 }, { shot: '-5-balanced-with-spare-row' },
  { click: '[data-testid="draft-review"]', wait: 800 }, { shot: '-6-review-card' }, { click: '[data-testid="draft-accept"]' }, { waitFor: '[data-testid="draft-done"]', wait: 800 }, { shot: '-7-done' }] });
await shot('02-draft-journal-bookkeeper-de', { role: 'backoffice', lang: 'de-DE', path: '/backoffice/accounting/journals', steps: [
  { click: '[data-testid="draft-open-journal"]', wait: 1500 }, { select: 'lines.0.account_id', option: '5300' }, { fill: 'input[name="lines.0.debit"]', value: '120' }, { select: 'lines.1.account_id', option: '1110' }, { fill: 'input[name="lines.1.credit"]', value: '120' }, { click: '[data-testid="draft-review"]', wait: 800 }, { shot: '-1-review-card' }] });
await shot('03-draft-journal-bookkeeper-ar-rtl', { role: 'backoffice', lang: 'ar-XA', rtl: true, path: '/backoffice/accounting/journals', steps: [
  { click: '[data-testid="draft-open-journal"]', wait: 1500, dispatch: true }, { select: 'lines.0.account_id', option: '5300' }, { fill: 'input[name="lines.0.debit"]', value: '120' }, { shot: '-1-form' }] });
