...
await shot('01-reports-pnl-admin-en', { ...A, path: '/backoffice/reports/pnl' });
await shot('02-reports-aging-admin-en', { ...A, path: '/backoffice/reports/aging' });
await shot('03-reports-pnl-admin-de', { role: 'admin', lang: 'de-DE', path: '/backoffice/reports/pnl' });
await shot('04-reports-aging-admin-ar-rtl', { role: 'admin', lang: 'ar-XA', path: '/backoffice/reports/aging', rtl: true });
await shot('05-reports-pnl-bookkeeper-en', { role: 'backoffice', lang: 'en-US', path: '/backoffice/reports/pnl' });
await shot('06-reports-aging-salesperson-no-access-en', { role: 'backoffice', lang: 'en-US', path: '/backoffice/reports/aging' });
