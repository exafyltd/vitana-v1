...
await shot('01-sales-leads-admin-en', { ...A, path: '/backoffice/sales/leads', click: 'table tbody tr' });
await shot('02-sales-contacts-admin-en', { ...A, path: '/backoffice/sales/contacts' });
await shot('03-sales-opportunities-admin-en', { ...A, path: '/backoffice/sales/opportunities' });
await shot('04-sales-followups-admin-en', { ...A, path: '/backoffice/sales/followups' });
await shot('05-sales-quotations-admin-en', { ...A, path: '/backoffice/sales/quotations', click: 'table tbody tr' });
await shot('06-sales-invoices-admin-en', { ...A, path: '/backoffice/sales/invoices', click: 'table tbody tr' });
await shot('07-sales-credit-notes-admin-en', { ...A, path: '/backoffice/sales/credit-notes' });
await shot('08-sales-invoices-admin-de', { role: 'admin', lang: 'de-DE', path: '/backoffice/sales/invoices', click: 'table tbody tr' });
await shot('09-sales-opportunities-admin-ar-rtl', { role: 'admin', lang: 'ar-XA', path: '/backoffice/sales/opportunities', rtl: true });
await shot('10-sales-leads-bookkeeper-no-access-en', { role: 'backoffice', lang: 'en-US', path: '/backoffice/sales/leads' });
await shot('11-sales-contacts-salesperson-en', { role: 'backoffice', lang: 'en-US', path: '/backoffice/sales/contacts' });
