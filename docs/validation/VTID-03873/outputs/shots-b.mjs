...
await shot('06-decide-no-actions-bookkeeper-en', { role: 'backoffice', lang: 'en-US', path: '/backoffice/approvals/queue' });
await shot('07-policy-read-only-bookkeeper-en', { role: 'backoffice', lang: 'en-US', path: '/backoffice/approvals/policies' });
