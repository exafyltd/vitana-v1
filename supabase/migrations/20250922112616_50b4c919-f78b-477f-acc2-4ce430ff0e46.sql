...
BEGIN
  ...
  WHERE user_id = p_from_user_id AND currency_type = p_currency;
  ...
  WHERE user_id = p_to_user_id AND currency_type = p_currency;
  ...
  INSERT INTO public.wallet_transactions (
    ...
    'transfer', p_currency, p_currency,
    jsonb_build_object(
...
-- Create atomic wallet exchange function
...
BEGIN
  ...
  SELECT balance INTO v_from_balance FROM public.user_wallets 
  WHERE user_id = p_user_id AND currency_type = p_from_currency;
  ...
  UPDATE public.user_wallets 
  SET balance = balance + v_net_amount, updated_at = NOW()
  WHERE user_id = p_user_id AND currency_type = p_to_currency;
  ...
  INSERT INTO public.wallet_transactions (
    ...
    'exchange', p_from_currency, p_to_currency,
    jsonb_build_object(
