-- Fix the bootstrap_admin_user function with fully qualified column names in ON CONFLICT
...
BEGIN
  ...
  ON CONFLICT (memberships.user_id, memberships.tenant_id) DO UPDATE SET
    role = EXCLUDED.role,
