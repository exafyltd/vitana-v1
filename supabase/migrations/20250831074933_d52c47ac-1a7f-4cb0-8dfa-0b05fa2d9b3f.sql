-- Phase 1: Fresh start IAM migration (fixed syntax)
...
SET name = 'Earthlings', slug = 'earthlings'
...
CREATE TYPE tenant_role AS ENUM ('community', 'patient', 'professional', 'staff', 'admin');
