 ...
 *
 * Large flat pool of 40 diverse wellness/science/nature images.
 * Each article gets a unique photo via deterministic hash on article ID,
 * so no two adjacent articles in the feed share the same cover.
 *
 * Priority: article's own RSS image_url > hash-selected from pool.
 */

// 40 diverse, high-quality Unsplash photos spanning wellness, science,
// nature, food, fitness, meditation, labs, community — all landscape crops.
const IMAGE_POOL: string[] = [
  // Supplements & pills
  'https://images.unsplash.com/photo-1550572017-edd951b55104?w=800&h=500&fit=crop',
  ...
  'https://images.unsplash.com/photo-1543362906-acfc16c67564?w=800&h=500&fit=crop',
  // Exercise & fitness
  ...
  'https://images.unsplash.com/photo-1538805060514-97d9cc17730c?w=800&h=500&fit=crop',
  ...
  'https://images.unsplash.com/photo-1579165466741-7f35e4755660?w=800&h=500&fit=crop',
  ...
  'https://images.unsplash.com/photo-1471943311424-646960669fbc?w=800&h=500&fit=crop',
  'https://images.unsplash.com/photo-1487530811176-3780de880c2d?w=800&h=500&fit=crop',
  // Sleep & rest
  'https://images.unsplash.com/photo-1520206715542-7088b3d3c6a1?w=800&h=500&fit=crop',
  ...
  'https://images.unsplash.com/photo-1523362628745-0c100150b504?w=800&h=500&fit=crop',
  // Longevity & elderly wellness
  'https://images.unsplash.com/photo-1447005497901-b3e9ee359928?w=800&h=500&fit=crop',
  'https://images.unsplash.com/photo-1559757175-5700dde675bc?w=800&h=500&fit=crop',
  'https://images.unsplash.com/photo-1552196563-55cd4e45efb3?w=800&h=500&fit=crop',
  // Yoga & stretching
  ...
  // Outdoor wellness
  'https://images.unsplash.com/photo-1505576399279-0d309cb2bf73?w=800&h=500&fit=crop',
  ...
  // Medical & clinical
  'https://images.unsplash.com/photo-1530026405186-ed1f139313f8?w=800&h=500&fit=crop',
  'https://images.unsplash.com/photo-1607619056574-7b8d3ee536b2?w=800&h=500&fit=crop',
  // Community & people
  ...
  // Morning sunlight / wellness vibe
  'https://images.unsplash.com/photo-1471864190281-a93a3070b6de?w=800&h=500&fit=crop',
  'https://images.unsplash.com/photo-1515894203077-7fe2d4e1a158?w=800&h=500&fit=crop',
];
 ...
 * Uses article ID to pick from the full 40-image pool — guarantees
 * adjacent articles in the feed get different photos.
 */
export function getNewsImage(tags: string[], articleId?: string): string {
  const seed = articleId || tags.join(',') + String(Date.now());
  return IMAGE_POOL[simpleHash(seed) % IMAGE_POOL.length];
}
