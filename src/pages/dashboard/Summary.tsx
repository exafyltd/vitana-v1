...
export default function Summary() {
  return (
    <AppLayout>
      <SEO title="AI Daily Summary | Dashboard" description="AI generated daily summary" canonical={window.location.href} />
      <SubNavigation items={dashboardSubItems} />
      <div className="p-6">
        <div className="rounded-xl border bg-card p-6 text-foreground shadow-sm">
          <h1 className="text-2xl font-semibold mb-4">AI Daily Summary</h1>
          <p className="text-muted-foreground">View your personalized AI-generated daily summary and insights.</p>
        </div>
      </div>
    </AppLayout>
  );
