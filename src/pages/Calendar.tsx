    ...
    <AppLayout>
      ...
      <div className="p-6">
        <div className="rounded-xl border bg-card p-6 text-foreground shadow-sm">
          ...
          <p className="text-muted-foreground">Organize your schedule, track appointments, and manage events. Navigate using the tabs above to access different calendar views.</p>
        </div>
      </div>
    </AppLayout>
  );
