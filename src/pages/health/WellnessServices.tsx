...
import { Stethoscope, Users, Target, Shield, Heart } from "lucide-react";
    ...
    <AppLayout>
      ...
      <div className="p-6 bg-gradient-to-br from-purple-50 via-blue-50 to-pink-50 min-h-screen">
        <div className="max-w-7xl mx-auto">
          <PageHeader 
            title="Professional care when you need it! 🏥"
            description="Book appointments, coaching sessions, and join wellness programs to support your health journey."
            icon={Heart}
          />
