    ...
    <AppLayout>
      ...
      <div className="p-6 bg-gradient-to-br from-purple-50 via-blue-50 to-pink-50 min-h-screen">
        ...
        <div className="rounded-xl border bg-card p-6 text-foreground shadow-sm mb-6">
          <h1 className="text-2xl font-semibold mb-4">Health Overview</h1>
          <p className="text-muted-foreground">Discover health services, programs, and educational resources</p>
        </div>
