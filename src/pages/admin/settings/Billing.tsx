    ...
    <AppLayout>
      ...
      <div className="p-6 space-y-4">
        ...
        {settingsQuery.isLoading && (
          <p className="text-sm text-muted-foreground py-8 text-center">Loading billing info...</p>
        )}
        ...
        {settingsQuery.data && hasBilling && (
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <Card>
              <CardHeader className="pb-2">
                <CardTitle className="text-sm text-muted-foreground">Usage Limit</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader className="pb-2">
                <CardTitle className="text-sm text-muted-foreground">Current Usage</CardTitle>
              </CardHeader>
              <CardContent>
