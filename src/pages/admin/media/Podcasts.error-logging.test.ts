/**
 * Podcasts.tsx admin moderation queue — error-visibility fix.
 *
 ...
 * renders as "no podcasts to review" — indistinguishable from a genuinely
 * empty moderation queue, hiding real pending episodes with nothing
 * logged.
 *
...
const SRC = readFileSync(join(__dirname, 'Podcasts.tsx'), 'utf8');

describe('Podcasts (admin) — moderation queue error logging', () => {
