    ...
    <div className="p-6 space-y-6">
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          System management and oversight center
        </p>
      </div>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-muted-foreground">Daily backup - 1 hour ago</p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-muted-foreground">Healthcare Clinic XYZ - 2 hours ago</p>
              </div>
            </div>
          </CardContent>
        </Card>
