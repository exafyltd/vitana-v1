    ...
    <AppLayout>
      ...
      <div className="p-6">
        <div className="rounded-xl border bg-card p-6 text-foreground shadow-sm">
          <h1 className="text-2xl font-semibold mb-4">Connected Apps</h1>
          <p className="text-muted-foreground">Manage your connected applications and third-party integrations.</p>
        </div>
      </div>
    </AppLayout>
  );
