...
import { Package, Clock, CheckCircle, XCircle, Truck, Calendar, MapPin, Star, Phone, MessageSquare, RotateCcw, Plane } from "lucide-react";
          ...
          <div className="flex flex-col lg:flex-row gap-4 mb-8">
            ...
            <div className="flex-1 bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-white/20">
              <div>
                ...
                <p className="text-muted-foreground">Track your wellness service bookings and product orders.</p>
              </div>
            </div>
