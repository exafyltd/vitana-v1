          ...
          <div className="w-full px-4 sm:px-6 lg:px-8">
            <div className="space-y-6 lg:space-y-8">
              ...
              <div className="w-full px-4 lg:px-6">
                <div className="grid gap-4 w-full lg:grid-cols-[360px,minmax(0,1fr)] h-[calc(100vh-300px)]">
                  <aside className="min-w-[300px] lg:min-w-0 border-r border-border">
                    <ConversationListSkeleton />
                  </aside>
                  <section className="min-w-0 w-full flex items-center justify-center">
