...
import { getUnsplashProfilePhoto } from '@/lib/unsplashFallback';
...
export function useDemoMatches() {
  ...
  const people: DemoPerson[] = [
    // THE MORNING OPTIMIZERS (3 profiles)
    {
      ...
      age: 34,
      avatar_url: getUnsplashProfilePhoto(0),
    ...
    },
    {
      ...
      age: 29,
      avatar_url: getUnsplashProfilePhoto(1),
    ...
    },
    {
      ...
      age: 41,
      avatar_url: getUnsplashProfilePhoto(2),
    ...
    // THE BIOHACKERS (2 profiles)
    {
      ...
      age: 38,
      avatar_url: getUnsplashProfilePhoto(3),
    ...
    },
    {
      ...
      age: 32,
      avatar_url: getUnsplashProfilePhoto(4),
    ...
    // THE WELLNESS PROFESSIONALS (3 profiles)
    {
      ...
      age: 36,
      avatar_url: getUnsplashProfilePhoto(5),
    ...
    },
    {
      ...
      age: 44,
      avatar_url: getUnsplashProfilePhoto(6),
    ...
    },
    {
      ...
      age: 39,
      avatar_url: getUnsplashProfilePhoto(7),
    ...
    // THE BALANCED EXPLORERS (3 profiles)
    {
      ...
      age: 27,
      avatar_url: getUnsplashProfilePhoto(8),
    ...
    },
    {
      ...
      age: 31,
      avatar_url: getUnsplashProfilePhoto(9),
    ...
    },
    {
      ...
      age: 35,
      avatar_url: getUnsplashProfilePhoto(10),
    ...
    // THE MINDFULNESS SEEKERS (2 profiles)
    {
      ...
      age: 43,
      avatar_url: getUnsplashProfilePhoto(11),
    ...
    },
    {
      ...
      age: 37,
      avatar_url: getUnsplashProfilePhoto(12),
    ...
    // THE FITNESS ENTHUSIASTS (2 profiles)
    {
      ...
      age: 28,
      avatar_url: getUnsplashProfilePhoto(13),
    ...
    },
    {
      ...
      age: 26,
      avatar_url: getUnsplashProfilePhoto(14),
    ...
    // THE NUTRITION NERDS (2 profiles)
    {
      ...
      age: 40,
      avatar_url: getUnsplashProfilePhoto(15),
    ...
    },
    {
      ...
      age: 33,
      avatar_url: getUnsplashProfilePhoto(16),
    ...
    // THE LONGEVITY ADVOCATES (2 profiles)
    {
      ...
      age: 52,
      avatar_url: getUnsplashProfilePhoto(17),
    ...
    },
    {
      ...
      age: 48,
      avatar_url: getUnsplashProfilePhoto(18),
    ...
    // THE COMMUNITY BUILDERS (2 profiles)
    {
      ...
      age: 30,
      avatar_url: getUnsplashProfilePhoto(19),
    ...
    },
    {
      ...
      age: 29,
      avatar_url: getUnsplashProfilePhoto(20),
    ...
    // THE RECOVERY EXPERT (1 profile)
    {
      ...
      age: 36,
      avatar_url: getUnsplashProfilePhoto(21),
  ...
  const coaches: DemoCoach[] = [
    {
      ...
      name: "Mia Torres",
      avatar: `https://api.dicebear.com/7.x/avataaars/svg?seed=11&backgroundColor=b6e3f4`,
    ...
    },
    {
      ...
      name: "Eric Novak",
      avatar: `https://api.dicebear.com/7.x/avataaars/svg?seed=12&backgroundColor=b6e3f4`,
      specialty: "Nutrition",
    ...
    },
    {
      ...
      name: "Anya Petrov",
      avatar: `https://api.dicebear.com/7.x/avataaars/svg?seed=13&backgroundColor=b6e3f4`,
    ...
    },
    {
      ...
      name: "Leo Park",
      avatar: `https://api.dicebear.com/7.x/avataaars/svg?seed=14&backgroundColor=b6e3f4`,
