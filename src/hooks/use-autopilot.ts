...
const generateMockActions = (): AutopilotAction[] => [
  ...
  {
    id: "2", 
    title: "New Mobility & Flow micro-class matches your schedule",
    reason: "Available 2PM slot aligns with your energy patterns",
    category: "discover",
    priority: "medium",
    timeEstimate: "1 min",
    icon: "🤸",
  ...
  },
  {
    ...
    reason: "You're on track! One more day to reach weekly goal",
    category: "health", 
    priority: "medium",
    timeEstimate: "30 sec",
    icon: "💧",
  ...
  {
    id: "4",
    title: "Auto-invite 3 friends to this weekend's Maxina Meetup?",
  ...
  {
    id: "6",
    title: "Save: 'Longevity Mindset' podcast episode",
