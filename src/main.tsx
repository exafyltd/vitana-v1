...
const PERSIST_KEYS = ['profiles', 'tenant', 'user_preferences', 'health-plans', 'life-compass', 'global-community-events', 'wallet-balances', 'organizer-events', 'live-streams', 'calendar-events'];
