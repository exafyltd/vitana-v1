  ...
  return (
    <Card 
      className={cn(
        ...
        "before:absolute before:inset-0 before:bg-[radial-gradient(circle_at_15%_20%,rgba(6,182,212,0.06)_0%,transparent_30%),radial-gradient(circle_at_85%_30%,rgba(14,165,233,0.05)_0%,transparent_25%),radial-gradient(circle_at_40%_80%,rgba(34,211,238,0.04)_0%,transparent_35%),radial-gradient(circle_at_70%_60%,rgba(56,189,248,0.045)_0%,transparent_28%)] before:pointer-events-none before:opacity-60 group-hover:before:opacity-100 before:transition-opacity before:duration-300",
      ...
      <div className="p-4 md:p-5">
        ...
        <div className="mb-2">
          ...
          <div className="relative h-2 w-full overflow-hidden rounded-full bg-slate-100 dark:bg-slate-800">
            <div 
              className="h-full bg-cyan-600 dark:bg-cyan-500 transition-all ease-in-out duration-500 rounded-full"
