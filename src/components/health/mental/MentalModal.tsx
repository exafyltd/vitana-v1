        ...
        <div className="space-y-6 mt-4">
          ...
          <div className="bg-white/60 dark:bg-slate-900/50 rounded-xl p-4 backdrop-blur-sm border border-slate-200/60 dark:border-slate-800/60">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-sm font-medium text-slate-600 dark:text-slate-400">Mindfulness Duration</span>
            </div>
          ...
          {data.tags.length > 0 && (
            <div className="space-y-2">
              <p className="text-sm font-medium text-slate-600 dark:text-slate-400">Activities Completed</p>
          ...
          <div className="bg-white/60 dark:bg-slate-900/50 rounded-xl p-4 backdrop-blur-sm border border-slate-200/60 dark:border-slate-800/60">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-sm font-medium text-slate-600 dark:text-slate-400 mb-1">AI Insight</p>
