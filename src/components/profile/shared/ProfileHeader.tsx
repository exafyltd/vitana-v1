  ...
  return (
    <div className="relative pt-20">
      ...
      <div className="px-6 pb-6 relative">
        ...
        {/* Name, Handle, VITANA Index, and Actions - Centered */}
        <div className="text-center mb-4">
          <div className="flex items-center justify-center gap-4 mb-2">
            ...
            {/* VITANA Index Badge - Inline with name */}
            {profile.vitanaIndex && (
              <div className="relative flex items-center">
                {/* Pulsing glow effect */}
                <div className="absolute inset-0 w-16 h-16 rounded-full bg-white/40 blur-lg animate-pulse"></div>
                
                {/* Main circular badge */}
                <div className="relative w-16 h-16 rounded-full bg-gradient-to-br from-gray-100 via-gray-200 to-gray-300 shadow-xl border border-gray-300/60 flex flex-col items-center justify-center animate-pulse"
                     style={{
                  ...
                  <div className="flex flex-col items-center justify-center text-center">
                    <div className="text-xl font-bold leading-none" style={{color: '#006D5B'}}>{profile.vitanaIndex}</div>
                    <div className="text-[7px] font-medium leading-tight mt-0.5" style={{color: '#2C2C2C'}}>
          ...
          <div className="flex items-center justify-center gap-2 mb-3">
            ...
            {/* Longevity Archetype next to handle */}
