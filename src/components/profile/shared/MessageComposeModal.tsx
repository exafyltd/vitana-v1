      ...
      <DialogContent overlayClassName="z-[60]" className="z-[60] sm:max-w-[520px] p-0 gap-0 bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl border border-white/40 dark:border-gray-800/40 shadow-[0_20px_60px_rgba(0,0,0,0.2)] rounded-3xl overflow-hidden animate-in fade-in-0 zoom-in-95 duration-300">
        ...
        <div className="p-6 space-y-4">
          <Textarea
            ...
            className="min-h-[140px] resize-none bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm border-white/40 dark:border-gray-700/40 rounded-2xl focus:ring-2 focus:ring-[hsl(var(--sys-vitana-accent))]/30 transition-all"
            autoFocus
          />
          ...
          <div className="flex items-center justify-between pt-2">
            <Button
              variant="ghost"
              size="sm"
              className="gap-2 text-muted-foreground hover:text-foreground transition-colors opacity-50"
              disabled
            >
              <Paperclip className="h-4 w-4" />
              <span className="text-xs">Attach (soon)</span>
            </Button>
