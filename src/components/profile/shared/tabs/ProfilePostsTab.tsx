...
import { Heart, MessageSquare, Share, Edit3, MapPin, ExternalLink, Trash2, PenSquare } from "lucide-react";
            ...
            >
              ...
              <div className="space-y-4 relative px-5 py-4 md:px-6 md:py-5">
                ...
                <div className="flex items-center gap-6 px-3 py-2 rounded-full bg-gradient-to-r from-violet-50/70 to-sky-50/70 dark:from-white/5 dark:to-white/10">
                  <button className="flex items-center gap-2 text-muted-foreground hover:text-pink-500 transition-all duration-200 group" aria-label="Like post">
                    <Heart className="h-4 w-4 group-hover:fill-current group-hover:scale-[1.05] transition-all" />
                    <span className="text-sm font-medium">{post.likes_count}</span>
                  </button>
                  <button className="flex items-center gap-2 text-muted-foreground hover:text-blue-500 transition-all duration-200 group" aria-label="Comment">
                    <MessageSquare className="h-4 w-4 group-hover:fill-current group-hover:scale-[1.05] transition-all" />
                    <span className="text-sm font-medium">{post.comments_count}</span>
                  </button>
                  <button className="flex items-center gap-2 text-muted-foreground hover:text-violet-500 transition-all duration-200 group" aria-label="Share">
                    <Share className="h-4 w-4 group-hover:fill-current group-hover:scale-[1.05] transition-all" />
