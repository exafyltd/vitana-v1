  ...
  return (
    <Card className="relative">
      ...
      <CardHeader className="pb-3">
        ...
        <CardDescription>Test results & biomarkers</CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between text-sm">
            <span>Latest: Complete Blood Panel</span>
            <Badge variant="secondary" className="text-xs">Jan 15</Badge>
          </div>
          <div className="flex items-center justify-between text-sm">
            <span>Pending: Lipid Profile</span>
