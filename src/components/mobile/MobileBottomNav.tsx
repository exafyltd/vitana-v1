...
export function MobileBottomNav() {
  ...
  return (
    ...
    >
      <div className="<div className="relative flex items-end justify-between bg-background/95 backdrop-blur-3xl border-t border-foreground/8 pb-safe pt-2 px-4 shadow-[0_-1px_3px_0_hsl(var(--foreground)/0.03)]"> <div className="relative flex items-end justify-between bg-background/95 backdrop-blur-3xl border-t border-foreground/8 pb-safe pt-2 px-4 shadow-[0_-1px_3px_0_hsl(var(--foreground)/0.03)]">[0_-1px_3px_0_hsl(var(--foreground)/0.03)]">
        {navItems.map((item) => (
          <NavItem
            key={item.id}
            {...item}
