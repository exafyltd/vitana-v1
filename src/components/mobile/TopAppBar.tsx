...
export function TopAppBar({ onMenuClick }: TopAppBarProps) {
  ...
  return (
    ...
    >
      ...
      <div className="relative h-11 flex items-center px-3">
        {/* Kebab menu – left */}
        <button
          onClick={onMenuClick}
          className="relative z-10 flex items-center justify-center w-9 h-9 rounded-lg transition-colors hover:bg-white/10"
        ...
        <span
          className="absolute left-1/2 -translate-x-1/2 z-10 font-semibold tracking-[0.08em] text-[22px] select-none"
