...
export function VertexMediaPreview({ 
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="text-base">📹 AI Vision Preview</CardTitle>
        <CardDescription>What the AI can see</CardDescription>
      </CardHeader>
      <CardContent className="space-y-3">
        ...
        {isScreenSharing && (
          <div className="border-2 border-blue-500 rounded-lg p-3 bg-blue-50">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="font-medium text-sm text-blue-900">Screen Sharing Active</span>
            </div>
        ...
        {isCameraActive && (
          <div className="border-2 border-green-500 rounded-lg p-3 bg-green-50">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="font-medium text-sm text-green-900">Camera Active</span>
            </div>
        ...
        {isRecording && (
          <div className="border-2 border-red-500 rounded-lg p-3 bg-red-50">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="font-medium text-sm text-red-900">Microphone Active</span>
            </div>
        ...
        {!isScreenSharing && !isCameraActive && !isRecording && (
          <div className="text-center py-6 text-muted-foreground">
            ...
            <p className="text-sm">No active inputs</p>
          </div>
        )}
      </CardContent>
    </Card>
