        ...
        >
          ...
          {(title || !hideCloseButton) && (
            <div className="flex items-center justify-between px-4 py-2 border-b">
              ...
              {!title && <div />}
              {!hideCloseButton && (
                <SheetPrimitive.Close style={{ border: 'none', background: 'transparent', outline: 'none', padding: 0, WebkitAppearance: 'none' }} className="w-11 h-11 flex items-center justify-center rounded-full hover:bg-accent -mr-2">
                  <X className="h-5 w-5" />
