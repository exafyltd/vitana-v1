 ...
 *
 * Flag/endonym presentation comes from the shared `LOCALE_PRESENTATION` map
 * (`@/components/language/locale-presentation`) — the in-app pickers (mobile
 * drawer, desktop sidebar) reuse the same map so it never drifts into a
