      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            {!file ? (
              ...
              <div className="relative rounded-2xl overflow-hidden bg-black">
                ...
                <div className="p-2 bg-black/80 text-white text-sm">{t('screens.community.nameValue1Mb', { name: file.name, value1: (file.size / 1024 / 1024).toFixed(2) })}
                </div>
              </div>
            )}
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground mb-2">{t('screens.community.jpgPngWebpAutogeneratedIfNot')}
            </p>
            {!thumbnailFile ? (
              <div
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder={t('screens.community.giveYourShortCatchyTitle')}
              maxLength={100}
              required
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              placeholder={t('screens.community.tellViewersWhatYourShortAbout')}
              rows={3}
              maxLength={500}
              disabled={isUploading}
            />
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder={t('screens.community.eGFitnessWellnessNutrition')}
              maxLength={50}
              disabled={isUploading}
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              <Input
                ...
                placeholder={t('screens.community.addTagPressEnter')}
                disabled={isUploading}
              />
              <Button
                type="button"
