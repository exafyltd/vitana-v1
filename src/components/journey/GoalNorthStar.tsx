...
export function GoalNorthStar({
  ...
  // loading. The guided card renders independently of `goal` (line 72 above:
  // a user can have a Life Compass goal AND be in Guided Mode), so
  // guided-not-ready must gate on its own — requiring `!goal` here let any
  // user with an existing goal skip this spinner and fall through to the
  // zero-data render below.
